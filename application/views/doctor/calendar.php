                   ...
                   <form name="calset_form" id="calset_form" <?php echo form_open('calendar/calset_form'); ?>
                       ...
                       <div class="large-3 columns">
                          <div class="availability_div">  
                            <label>Off Day </label>
                            <select name="off_day_0" class="off_day">
                                <option value="0" <?php if($calendar['0']['off_day'] == '0'){echo "selected";}?>> FALSE </option>
                                <option value="1" <?php if($calendar['0']['off_day'] == '1'){echo "selected";}?>> TRUE</option>
                            </select>
                          </div>
                          <div class="availability_div">  
                            <label>Off Day </label>
                            <select name="off_day_1" class="off_day">
                                <option value="0" <?php if($calendar['1']['off_day'] == '0'){echo "selected";}?>> FALSE </option>
                                <option value="1" <?php if($calendar['1']['off_day'] == '1'){echo "selected";}?>> TRUE</option>
                            </select>
                          </div>
                          <div class="availability_div">  
                            <label>Off Day </label>
                            <select name="off_day_2" class="off_day">
                                <option value="0" <?php if($calendar['2']['off_day'] == '0'){echo "selected";}?>> FALSE </option>
                                <option value="1" <?php if($calendar['2']['off_day'] == '1'){echo "selected";}?>> TRUE</option>
                            </select>
                          </div>
                          <div class="availability_div">  
                            <label>Off Day </label>
                            <select name="off_day_3" class="off_day">
                                <option value="0" <?php if($calendar['3']['off_day'] == '0'){echo "selected";}?>> FALSE </option>
                                <option value="1" <?php if($calendar['3']['off_day'] == '1'){echo "selected";}?>> TRUE</option>
                            </select>
                          </div>
                          <div class="availability_div">  
                            <label>Off Day </label>
                            <select name="off_day_4" class="off_day">
                                <option value="0" <?php if($calendar['4']['off_day'] == '0'){echo "selected";}?>> FALSE </option>
                                <option value="1" <?php if($calendar['4']['off_day'] == '1'){echo "selected";}?>> TRUE</option>
                            </select>
                          </div>
                          <div class="availability_div">  
                            <label>Off Day </label>
                            <select name="off_day_5" class="off_day">
                                <option value="0" <?php if($calendar['5']['off_day'] == '0'){echo "selected";}?>> FALSE </option>
                                <option value="1" <?php if($calendar['5']['off_day'] == '1'){echo "selected";}?>> TRUE</option>
                            </select>
                          </div>
                          <div class="availability_div">  
                            <label>Off Day </label>
                            <select name="off_day_6" class="off_day">
                                <option value="0" <?php if($calendar['6']['off_day'] == '0'){echo "selected";}?>> FALSE </option>
                                <option value="1" <?php if($calendar['6']['off_day'] == '1'){echo "selected";}?>> TRUE</option>
                            </select>
                          </div>
                       </div>
