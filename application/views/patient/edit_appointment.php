        ...
        <div class="row">
          <div class="large-8 columns">
            <?php
               ...
               ?>
            <form method="post" class="appointment_form" name="edit_appointment" id="edit_appointment" <?php echo form_open('patient/edit_appointment/'.$user_appointment['0']['appointment_id']); ?>
              ...
              <div class="appointment_details">
                ...
                <div class="input-group-button">
                    <button type="submit" class="button appointment_button"> Request Appointment</button>
                </div>
              </div>
            </form>
          </div>
