        ...
        <div class="row">
          <div class="large-8 columns"> 
              ...
              <div class="row">
                ...
                <form method="post" class="review_form" name="review_form" id="review_form" <?php echo form_open('patient/review_edit/'.$review['0']['review_id']); ?>
                  ...
                  <div class="appointment_details">
                    <div class="input-group">
                      <label> Doctor Rating : </label>
                        <span class="rating">
                          ...
                          <?php if($review[0]['review_rating']== 5){echo "checked";}?>
                          /><label for="star5" title="Rocks!">5 stars</label>
                          <input type="radio" id="star4" name="rating" value="4" 
                          <?php if($review[0]['review_rating']== 4){echo "checked";}?>
                          /><label for="star4" title="Pretty good">4 stars</label>
                          <input type="radio" id="star3" name="rating" value="3" 
                          <?php if($review[0]['review_rating']== 3){echo "checked";}?>
                          /><label for="star3" title="Meh">3 stars</label>
                          <input type="radio" id="star2" name="rating" value="2" 
                          <?php if($review[0]['review_rating']== 2){echo "checked";}?>
                          /><label for="star2" title="Kinda bad">2 stars</label>
                          <input type="radio" id="star1" name="rating" value="1" 
                          <?php if($review[0]['review_rating']== 1){echo "checked";}?>
                    ...
                    <div class="input-group">
                        ...
                        <textarea type="text" rows="5" name="doctor_review" placeholder="Doctor Review" class="primary_color" value="<?php echo set_value('doctor_review'); ?>" required><?php echo $review[0]['review_desc']; ?>
                        </textarea>
                    </div>
